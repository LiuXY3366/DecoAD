...
def init_sub_args(args):
    ...
    if dataset == 'NWPUC' or dataset == 'NWPUCUB':
        args.pose_path = {'train': os.path.join(args.data_dir, dataset, 'pose_un', 'train/'),
                        'test':  os.path.join(args.data_dir, dataset, 'pose_un', 'test/')}
    else:
...
def init_parser(default_dataset = 'NWPUCUB', default_data_dir='/home/liuxinyu/PycharmProjects/VAD/data/',default_exp_dir='/home/liuxinyu/PycharmProjects/VAD/data/exp_dir'):
    ...
    parser.add_argument('--UNVAD', type=str,
                        default='/home/liuxinyu/PycharmProjects/VAD/DecoVAD/UNVAD/',
                        help='Path to UNVAD')
    ...
    parser.add_argument('--opbs', type=int, default=4096*4, help='maximum iteration to train (default: 100)')
