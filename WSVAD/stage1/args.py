...
def init_parser(default_dataset = 'UFSR',default_data_dir='/home/liuxinyu/PycharmProjects/VAD/data/', default_exp_dir='/home/liuxinyu/PycharmProjects/VAD/data/exp_dir'):
    parser = argparse.ArgumentParser(prog="DecoAD")
    parser.add_argument('--pose_path_train_abnormal', type=str,
                        default=f'/home/liuxinyu/PycharmProjects/VAD/data/{default_dataset}/pose/abnormal_train/',
                        help='Path to training vids')
    parser.add_argument('--WSVAD', type=str,
                        default='/home/liuxinyu/PycharmProjects/VAD/DecoVAD/WSVAD/',
                        help='Path to WSVAD')
    parser.add_argument('--DATA', type=str,
                        default='/home/liuxinyu/PycharmProjects/VAD/data/',
                        help='Path to DATA')
    ...
    parser.add_argument('--supervise', type=str, default='W',choices=['W', 'S', 'U'])
    ...
    parser.add_argument('--lr2',type=float,default=0.0000001)
    parser.add_argument('--weight_decay2',type=float,default=0.00000005)
    parser.add_argument('--opbs', type=int, default=4096, help='maximum iteration to train (default: 100)')
    ...
    # Data Params
    parser.add_argument('--num_transform', type=int, default=8, metavar='T', help='number of transformations to use for augmentation (default: 2)')
