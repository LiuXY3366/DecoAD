...
def init_sub_args(args):
    dataset = "UBnormal" if args.dataset == "UBnormal" else "UBnormal"
    ...
    # args.pose_path["train_abnormal"] = '/home/liuxinyu/PycharmProjects/KG-VAD/data/UBnormal/pose/abnormal_train/'
...
def init_parser(default_data_dir='/home/liuxinyu/PycharmProjects/KG-VAD/data/', default_exp_dir='/home/liuxinyu/PycharmProjects/KG-VAD/data/exp_dir'):
    ...
    parser.add_argument('--pose_path_train_abnormal', type=str, default='/home/liuxinyu/PycharmProjects/KG-VAD/data/UBnormal/pose/abnormal_train/', help='Path to training vids')
    ...
    parser.add_argument('--dataset', type=str, default='UBnormal',
                        choices=['ShanghaiTech', 'ShanghaiTech-HR', 'UBnormal','NWPUC'], help='Dataset for Eval')
