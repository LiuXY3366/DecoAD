...
from utils.AlphaPose.alphapose.utils.transforms import get_func_heatmap_to_coord
from utils.AlphaPose.alphapose.utils.pPose_nms import pose_nms, write_json
...
class DataWriter():
    def __init__(self, cfg, opt, save_video=False,
        ...
        if opt.pose_flow:
            from utils.AlphaPose.trackers.PoseFlow.poseflow_infer import PoseFlowWrapper
            ...
            if boxes is None or len(boxes) == 0:
                ...
                if self.opt.save_img or self.save_video or self.opt.vis:
                    if hm_data.size()[1] == 49:
                        from utils.AlphaPose.alphapose.utils.vis import vis_frame_dense as vis_frame
                    elif self.opt.vis_fast:
                        from utils.AlphaPose.alphapose.utils.vis import vis_frame_fast as vis_frame
                    else:
                        from utils.AlphaPose.alphapose.utils.vis import vis_frame
